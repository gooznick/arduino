...
#define  c     3830    // 261 Hz do 1
#define  d     3400    // 294 Hz re 2
#define  e     3038    // 329 Hz mi 3
#define  f     2864    // 349 Hz     4
#define  g     2550    // 392 Hz    5
#define  a     2272    // 440 Hz    6
#define  b     2028    // 493 Hz    7
...
int melody[] = {  c,  d,  f,  e,  g,   f,  d,  f,  e,  g, d, g , g  , c ,d , f , e, g , f , d , f,e,g,d,R};
int beats[]  = { 8, 16, 8,  8,  8,  16, 8, 8, 8, 8, 8, 8 ,16,8,16,8,8,8,16,8,8,8,8,32,16}; 
...
void loop() {
  ...
  for (int i=0; i<MAX_COUNT; i++) {
    ...
    duration = beat *2 * tempo; // Set up timing
